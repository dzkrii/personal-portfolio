export const messages = {
  id: {
    ...
    cvDocTitle: "Dokumen CV Resmi",
    downloadCv: "Unduh CV (PDF)",
    downloadCvId: "Unduh Versi Bahasa Indonesia",
    downloadCvEn: "Unduh Versi English",
    openPdfInNewTab: "Buka PDF di Tab Baru",
    switchCvVersion: "Pilih Versi Dokumen",
    mobileCvNotice:
  ...
  en: {
    ...
    cvTitle: "Curriculum Vitae",
    cvDocTitle: "Official CV Document",
    downloadCv: "Download CV (PDF)",
    downloadCvId: "Download Indonesian Version",
    downloadCvEn: "Download English Version",
    openPdfInNewTab: "Open PDF in New Tab",
    switchCvVersion: "Select Document Version",
    mobileCvNotice:
